...
public class BackgroundOld extends Expressions{
  ...
  // listIEqForIExpr(iExpr) est la liste des iEq identifiants
	...
	public BackgroundOld(final int memorySize, int nbrLetters)
	{
	...
	public void reinit()
	{
		...
		sizeExprs = new long [tree.length] ;
  ...
  public void setHasMDFA()
	...
	public void unify(int iExpr1, int iExpr2)
	{		
